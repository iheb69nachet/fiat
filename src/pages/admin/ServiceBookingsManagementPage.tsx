          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {bookings.map(booking => (
              <tr key={booking.id}>
                ...
                <td className="px-6 py-4">
                  <div className="text-sm font-medium text-gray-900">
                    {booking.car_details.year} {booking.car_details.make} {booking.car_details.model}
                  </div>
                  {booking.car_details.vin && (
                    <div className="text-sm text-gray-500">VIN: {booking.car_details.vin}</div>
                  )}
                </td>
                <td className="px-6 py-4">
